...
async def run_checks(
    ...
    return [
        ...
        without_spending,
        without_balances,
        # `sec199a_in_itemized` was here from 2026-09-09 to 2026-09-11. It named years whose
        # STORED itemized total still had the §199A line inside it, deducting those dollars
