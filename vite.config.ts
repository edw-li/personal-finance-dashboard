...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      // Shell environment ONLY: vite does not load .env files before evaluating this config,
      // so an .env.local line cannot set it — it has to be on the command that starts vite.
