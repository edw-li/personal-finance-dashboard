  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        steps: [
          'Press **Change…** beside the filing status in the sticky row, and pick **Single**, **Married filing jointly** or **Married filing separately**.',
          'Read what it would mean — whose inputs count, missing tables, next year’s safe harbor — then press **Change to <status>**.',
          'The change is logged: **Undo** on the toast puts the old status back.',
      ...
      },
      {
        ...
        watch: [
          'Unsaved edits survive leaving the page, a reload or a sign-in as a draft for this browser tab — **Discard restored entries** drops one, and it is dropped for you if the saved values changed meanwhile.',
        ],
        keywords: ['inputs', 'w-2', 'deductions', 'line items', 'tax inputs', 'unsaved', 'draft'],
      },
      {
        id: 'taxes-will-i-owe',
        ...
        steps: [
          ...
          'Under it, **Your inputs vs your records** sets each typed input beside what Paycheck, RSU grants and ESPP lots project.',
          'A line badged **differs** moves more than $250 of tax — fix it in Inputs; nothing is written for you.',
        ],
        to: '/taxes',
        watch: [
          'A blank balance means the engine refused for want of tables — not that you are even.',
          'The balance stays on your typed inputs; **Balance if they matched your records** says where fixing them would land.',
        ],
        keywords: ['owe', 'refund', 'withholding', 'safe harbor', 'w-4', 'balance due', 'reconcile', 'records'],
      },
      {
        ...
        steps: [
          ...
          'Read **Proceeds**, **Tax due**, **Net cash** and **After-tax gain**; nothing is stored, and the address carries the scenario.',
        ],
    ...
    watch: [
      'In Tax tables, **Tables for status** picks which tables you edit — the year’s own is marked, and editing another status moves no totals.',
