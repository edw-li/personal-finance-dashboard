    ...
    tasks: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Pick **Long** or **Short** yourself — the app cannot verify a holding period.',
    ...
    more: [
      {
        ...
        where: 'Taxes → Tax tables',
        steps: [
          'Open the empty married tab and press **Clone from <year> single tables** — the source is always the same year.',
      ...
      },
      {
        ...
        steps: [
          ...
          'Edit it and press **Save**. **Discard draft** throws away an unsaved one; **Remove — use the default** deletes a stored one.',
        ],
        to: '/taxes?section=tables',
      ...
      },
      {
        ...
        where: 'Taxes → Summary → Will I owe?',
        steps: ['Press the **Apply** chip beside the vest sentence — it writes the projected vest income to **W2: Stock/RSUs Sold** for the primary person.'],
        to: '/taxes',
      },
      {
        id: 'taxes-pin',
      ...
      },
      {
        ...
        where: 'Taxes → New tax year…',
        steps: ['Open the year menu, press the delete entry, and confirm inside the popover — the year’s inputs and tables go with it.'],
        to: '/taxes',
      },
      {
        id: 'taxes-marginal',
        ...
        steps: ['Where this year’s taxable income sits in each ladder, and what the next $1,000 of ordinary income costs.'],
        to: '/taxes',
      },
    ],
    watch: [
