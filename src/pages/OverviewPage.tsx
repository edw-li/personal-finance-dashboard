        ...
        <div className={`loading-dim${busy ? ' is-loading' : ''}`}>
          ...
          <div className="card-grid">
            <section className="card span-12">
              ...
              {spark ? (
                <EChart option={spark} height={220} onClick={() => navigate('/net-worth')} />
              ) : (
            ...
            <section className="card span-12">
              ...
              {perf ? (
                <EChart option={perf} height={280} onClick={() => navigate('/portfolio')} />
              ) : (
            ...
            <section className="card span-12">
              ...
              {bars ? (
                <EChart option={bars} height={240} onClick={openSpendingMonth} />
              ) : (
