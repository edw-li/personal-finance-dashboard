...
// Units (2026-09-09 spec §2) — the box ↔ wire rules live in ./inputUnits, shared with the
// What-if override row since 2026-09-23 (spec §B7 review), so both boxes speak one unit rule.
