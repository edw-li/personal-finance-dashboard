...
describe('skeletonMetrics', () => {
  ...
  it('converts an outer box to a ghost BODY (never negative), sizes a chart card, derives each feed', () => {
    ...
    expect([FEED_SKELETON.paycheckBreakdown, FEED_SKELETON.compVesting, FEED_SKELETON.compEvents, FEED_SKELETON.esppLots, FEED_SKELETON.esppOfferings]).toEqual([450, 57, 357, 315, 216])
  })
