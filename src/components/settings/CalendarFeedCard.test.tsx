...
describe('CalendarFeedCard', () => {
  ...
  it('says what the monthly reminder lists, on the saved day', async () => {
    // On day 1 the reminder's day IS the balances' day; on any other day they are still that
    // month's 1st balances (review minor 3) — never "that day's".
    const note = (day: number) =>
      `The Monthly update reminder lands on day ${day} of each month and lists what is due: ${day === 1 ? 'that day’s balances' : 'that month’s 1st balances'} and the previous month’s spending and take-home. It shows on the calendar and in the feed (with an alarm three days before). Any day from 1 to 28 — every month has one.`
